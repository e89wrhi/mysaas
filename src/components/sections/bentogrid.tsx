        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="col-span-2 p-8">
            <div className="grid h-full sm:grid-cols-1">
              ...
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-1 before:rounded-full before:bg-green-500/70 sm:-my-8 sm:-mr-8">
                <div className="relative flex h-full flex-col justify-center space-y-8 py-8">
                  ...
                  {/* Second item */}
                  <div className="relative ml-[calc(50%-1.5rem)] flex items-center gap-3">
                    <div className="size-12 ring-6 ring-background">
                      <Image
                        width={120}
                        height={120}
          ...
          <div className="grid grid-rows-3 gap-4">
            {/* Third card */}
            <div className="relative col-span-full overflow-hidden rounded-2xl bg-background p-8 sm:col-span-3 lg:col-span-2">
              <div>
                <div>
                  <svg
            ...
            <div className="col-span-full flex overflow-hidden rounded-2xl bg-background p-8 lg:col-span-2">
              <div className="relative m-auto size-fit">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="text-gradient_orange-yellow mx-auto block w-fit font-heading text-5xl">
                    100%
                  </span>
                </div>
