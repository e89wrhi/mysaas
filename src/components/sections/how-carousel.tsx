...
const STEPS = [
  {
    ...
    description:
      'Easily connect your data sources. Our seamless integration allows you to sync your workspace in seconds.',
  ...
  },
  {
    ...
    description:
      'Our system analyzes your configurations, creating an optimized mental model tailored specifically to your needs.',
  ...
  },
  {
    ...
    description:
      'Watch the magic happen as our proprietary AI processes your data, yielding powerful insights at lightning speed.',
    image: '/_illustration/illu_device2_dark.png',
  },
  {
    id: 4,
    title: 'Action & Results',
    description:
      'Deploy actionable results with a single click. Elevate your productivity and focus on what truly matters.',
...
const textVariants = {
  ...
  center: { y: 0, opacity: 1, transition: { duration: 0.6, delay: 0.2 } },
